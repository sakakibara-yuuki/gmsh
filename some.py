...
step_files = os.path.join(path, os.pardir, '../../../fem/Unnamed.step')
import pathlib
p = pathlib.Path(step_files)
print('='*31)
print(p.resolve())
if p.exists():
    print('hoge')
print('='*31)
v = gmsh.model.occ.importShapes(step_files)
# v = gmsh.model.occ.importShapes('fem/Unnamed.step')
...
gmsh.model.occ.addBox(L, L, L, dx, dx, dx)
gmsh.model.occ.synchronize()
###############################################333
